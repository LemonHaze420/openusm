...
*/
__declspec(noreturn) __declspec(deprecated) _MRTIMP2_NCEEPURE void __CLRCALL_PURE_OR_CDECL _Debug_message(const char *,
                                                                                                          const char *);
/* 
...
class _CRTIMP2_PURE _Container_base {  // store head of iterator chain
public:
    friend class _Iterator_base;

    typedef _Undefined_move_tag _Move_category;

    __CLR_OR_THIS_CALL _Container_base() : _Myfirstiter(0)
    {  // construct childless container
    }

    __CLR_OR_THIS_CALL _Container_base(const _Container_base &) : _Myfirstiter(0)
    {  // copy a container
    }
...
// CLASS _Iterator_base
class _Iterator_base {  // store links to container, next iterator
public:
    ...
    __CLR_OR_THIS_CALL _Iterator_base() : _Mycont(0), _Mynextiter(0)
    {  // construct orphaned iterator
    }

    __CLR_OR_THIS_CALL _Iterator_base(const _Iterator_base &_Right) : _Mycont(0), _Mynextiter(0)
    {  // copy an iterator
        *this = _Right;
    }
    ...
    {                                     // assign an iterator
        if (_Mycont != _Right._Mycont) {  // change parentage
    ...
    {                              // adopt this iterator by parent
        if (_Mycont != _Parent) {  // change parentage
            _Lockit _Lock(_LOCK_DEBUG);
            _Orphan_me();
            if (_Parent != 0 && _Parent->_Myfirstiter != _IGNORE_MYITERLIST) {  // switch to new parent
    ...
    {                                                                       // cut ties with parent
        if (_Mycont != 0 && _Mycont->_Myfirstiter != _IGNORE_MYITERLIST) {  // adopted, remove self from list
...
{  // swap all iterators
    ...
    *(_Iterator_base **)&_Right._Myfirstiter = _Temp;
    ...
    if (_Myfirstiter != _IGNORE_MYITERLIST) {
        for (_Pnext = (_Iterator_base *)_Myfirstiter; _Pnext != 0; _Pnext = _Pnext->_Mynextiter)
            _Pnext->_Mycont = this;
    }
    if (_Right._Myfirstiter != _IGNORE_MYITERLIST) {
        for (_Pnext = (_Iterator_base *)_Right._Myfirstiter; _Pnext != 0; _Pnext = _Pnext->_Mynextiter)
...
inline const _Container_base *__CLRCALL_OR_CDECL _Debug_get_cont(const _Iter &)
...
inline bool __CLRCALL_OR_CDECL _Debug_lt(const _Ty1 &_Left, const _Ty2 &_Right, const wchar_t *_Where,
                                         unsigned int _Line)
...
template <class _Ty1, class _Ty2>
inline bool __CLRCALL_OR_CDECL _Debug_lt(const _Ty1 &_Left, _Ty2 &_Right, const wchar_t *_Where, unsigned int _Line)
{  // test if _Left < _Right and operator< is strict weak ordering
    if (!(_Left < _Right))
        return (false);
    else if (_Right < _Left)
...
template <class _Ty1, class _Ty2>
inline bool __CLRCALL_OR_CDECL _Debug_lt(_Ty1 &_Left, const _Ty2 &_Right, const wchar_t *_Where, unsigned int _Line)
{  // test if _Left < _Right and operator< is strict weak ordering
    if (!(_Left < _Right))
        return (false);
    else if (_Right < _Left)
...
template <class _Ty1, class _Ty2>
inline bool __CLRCALL_OR_CDECL _Debug_lt(_Ty1 &_Left, _Ty2 &_Right, const wchar_t *_Where, unsigned int _Line)
{  // test if _Left < _Right and operator< is strict weak ordering
    if (!(_Left < _Right))
        return (false);
    else if (_Right < _Left)
...
inline bool __CLRCALL_OR_CDECL _Debug_lt_pred(_Pr _Pred, const _Ty1 &_Left, const _Ty2 &_Right, const wchar_t *_Where,
                                              unsigned int _Line)
...
template <class _Pr, class _Ty1, class _Ty2>
inline bool __CLRCALL_OR_CDECL _Debug_lt_pred(_Pr _Pred, const _Ty1 &_Left, _Ty2 &_Right, const wchar_t *_Where,
                                              unsigned int _Line)
{  // test if _Pred(_Left, _Right) and _Pred is strict weak ordering
    if (!_Pred(_Left, _Right))
        return (false);
...
template <class _Pr, class _Ty1, class _Ty2>
inline bool __CLRCALL_OR_CDECL _Debug_lt_pred(_Pr _Pred, _Ty1 &_Left, const _Ty2 &_Right, const wchar_t *_Where,
                                              unsigned int _Line)
{  // test if _Pred(_Left, _Right) and _Pred is strict weak ordering
    if (!_Pred(_Left, _Right))
        return (false);
...
template <class _Pr, class _Ty1, class _Ty2>
inline bool __CLRCALL_OR_CDECL _Debug_lt_pred(_Pr _Pred, _Ty1 &_Left, _Ty2 &_Right, const wchar_t *_Where,
                                              unsigned int _Line)
{  // test if _Pred(_Left, _Right) and _Pred is strict weak ordering
    if (!_Pred(_Left, _Right))
        return (false);
...
#ifdef _DEBUG
class _Iterator_base;
class _CRTIMP2_PURE _Container_base {  // base of all containers
public:
    typedef _Undefined_move_tag _Move_category;
...
class _Iterator_base {  // base of all iterators
public:
    typedef _Unchecked_iterator_tag _Checked_iterator_category;
    typedef _Unchanged_checked_iterator_base_type_tag _Checked_iterator_base_type;
    typedef _Undefined_inner_type_tag _Inner_type;
    ...
    __CLR_OR_THIS_CALL ~_Iterator_base()
    {  // destroy the iterator
        if (_Mycont != 0 && _Mycont != _IGNORE_MYCONT && _Mycont->_Myfirstiter != 0 &&
            _Mycont->_Myfirstiter != _IGNORE_MYITERLIST)
...
#else
struct _Container_base {  // base of all containers
};
...
struct _ITERATOR_BASE {  // base of all iterators
    typedef _Unchecked_iterator_tag _Checked_iterator_category;
    typedef _Unchanged_checked_iterator_base_type_tag _Checked_iterator_base_type;
    typedef _Undefined_inner_type_tag _Inner_type;
...
struct _Float_iterator_tag {  // identifying tag for floating point types, not an iterator
};

// POINTER ITERATOR TAGS
struct _Nonscalar_ptr_iterator_tag {  // pointer to unknown type
};
struct _Scalar_ptr_iterator_tag {  // pointer to scalar type
};
...
template <class _Ty, class _Diff, class _Pointer,
          class _Reference>
...
struct _Outit_with_base : public _Iterator_with_base<output_iterator_tag, void, void, void, void,
                                                     _Base_class> {  // base for output iterators
};

// TEMPLATE CLASS iterator_traits
template <class _Iter>
struct iterator_traits {  // get traits from iterator _Iter
...
template <class _Ty>
struct iterator_traits<_Ty *> {  // get traits from pointer
    typedef random_access_iterator_tag iterator_category;
    typedef _Ty value_type;
...
template <class _Ty>
struct iterator_traits<const _Ty *> {  // get traits from const pointer
    typedef random_access_iterator_tag iterator_category;
    typedef _Ty value_type;
    typedef ptrdiff_t difference_type;
    typedef ptrdiff_t distance_type;  // retained
...
template <>
struct iterator_traits<char> {  // get traits from integer type
    typedef _Int_iterator_tag iterator_category;
...
template <>
struct iterator_traits<signed char> {  // get traits from integer type
    typedef _Int_iterator_tag iterator_category;
...
template <>
struct iterator_traits<unsigned char> {  // get traits from integer type
    typedef _Int_iterator_tag iterator_category;
...
template <>
struct iterator_traits<wchar_t> {  // get traits from integer type
    typedef _Int_iterator_tag iterator_category;
...
template <>
struct iterator_traits<short> {  // get traits from integer type
    typedef _Int_iterator_tag iterator_category;
...
template <>
struct iterator_traits<unsigned short> {  // get traits from integer type
    typedef _Int_iterator_tag iterator_category;
...
template <>
struct iterator_traits<int> {  // get traits from integer type
    typedef _Int_iterator_tag iterator_category;
...
template <>
struct iterator_traits<unsigned int> {  // get traits from integer type
    typedef _Int_iterator_tag iterator_category;
...
template <>
struct iterator_traits<long> {  // get traits from integer type
    typedef _Int_iterator_tag iterator_category;
...
template <>
struct iterator_traits<unsigned long> {  // get traits from integer type
    typedef _Int_iterator_tag iterator_category;
...
#ifdef _LONGLONG
template <>
struct iterator_traits<_LONGLONG> {  // get traits from integer type
    typedef _Int_iterator_tag iterator_category;
...
template <>
struct iterator_traits<_ULONGLONG> {  // get traits from integer type
    typedef _Int_iterator_tag iterator_category;
...
template <class _Iter>
inline typename iterator_traits<_Iter>::iterator_category __CLRCALL_OR_CDECL _Iter_cat(const _Iter &)
...
inline typename _Iter_random_helper<typename iterator_traits<_Iter1>::iterator_category,
                                    typename iterator_traits<_Iter2>::iterator_category>::_Iter_random_cat
    __CLRCALL_OR_CDECL
    _Iter_random(const _Iter1 &, const _Iter2 &)
{  // return category from iterator argument
    typename _Iter_random_helper<typename iterator_traits<_Iter1>::iterator_category,
                                 typename iterator_traits<_Iter2>::iterator_category>::_Iter_random_cat _Cat;
    return (_Cat);
}

template <class _Iter1, class _Iter2, class _Iter3>
inline typename _Iter_random_helper3<typename iterator_traits<_Iter1>::iterator_category,
...
{  // return category from iterator argument
    typename _Iter_random_helper3<typename iterator_traits<_Iter1>::iterator_category,
                                  typename iterator_traits<_Iter2>::iterator_category,
...
public:
    typedef typename _Checked_iterator_category_helper<_Iter, __is_base_of(_Iterator_base, _Iter)>::_Checked_cat
        _Checked_cat;
};
...
inline typename _Checked_iterator_base_helper<_Iter>::_Checked_iterator_base_type __CLRCALL_OR_CDECL
...
inline void __CLRCALL_OR_CDECL _Checked_assign_from_base(_DstIter &_Dest, const _BaseIter &_Src)
{
    _Dest._Checked_iterator_assign_from_base(_Src);
}

template <class _Iter>
inline void __CLRCALL_OR_CDECL _Checked_assign_from_base(_Iter &_Dest, const _Iter &_Src)
{
    _Dest = _Src;
}
...
template <class _Iter>
inline typename _Move_operation_category<typename iterator_traits<_Iter>::value_type>::_Move_cat
...
struct _Ptr_cat_helper {
    typedef typename _Ptr_cat_with_checked_cat_helper<_T1, _T2, typename _Checked_iterator_category<_T1>::_Checked_cat,
                                                      typename _Checked_iterator_category<_T2>::_Checked_cat>::_Ptr_cat
        _Ptr_cat;
};
...
template <>
struct _Ptr_cat_helper<char *, char *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<const char *, char *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<signed char *, signed char *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<const signed char *,
                       signed char *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<unsigned char *, unsigned char *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<const unsigned char *,
                       unsigned char *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};
...
template <>
struct _Ptr_cat_helper<wchar_t *, wchar_t *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<const wchar_t *, wchar_t *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

#endif /* _NATIVE_WCHAR_T_DEFINED */
template <>
struct _Ptr_cat_helper<short *, short *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<const short *, short *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<unsigned short *,
                       unsigned short *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<const unsigned short *,
                       unsigned short *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<int *, int *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<const int *, int *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<unsigned int *, unsigned int *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<const unsigned int *,
                       unsigned int *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<long *, long *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<const long *, long *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<unsigned long *, unsigned long *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<const unsigned long *,
                       unsigned long *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<float *, float *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<const float *, float *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<double *, double *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<const double *, double *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<long double *, long double *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<const long double *,
                       long double *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};
...
template <>
struct _Ptr_cat_helper<_LONGLONG *, _LONGLONG *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<const _LONGLONG *, _LONGLONG *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<_ULONGLONG *, _ULONGLONG *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <>
struct _Ptr_cat_helper<const _ULONGLONG *, _ULONGLONG *> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};
...
template <class _Ty>
struct _Ptr_cat_helper<_Ty **, _Ty **> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

template <class _Ty>
struct _Ptr_cat_helper<_Ty **, const _Ty **> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};
...
template <class _Ty>
struct _Ptr_cat_helper<_Ty *const *, const _Ty **> {  // return pointer category from pointer to pointer arguments
    typedef _Scalar_ptr_iterator_tag _Ptr_cat;
};

/* use _Ptr_cat_helper to determine the type of the pointer category */
template <class _T1, class _T2>
inline typename _Ptr_cat_helper<_T1, _T2>::_Ptr_cat __CLRCALL_OR_CDECL _Ptr_cat(_T1 &, _T2 &)
{
...
#define _DEBUG_ORDER(first, last) _DEBUG_ORDER_IMPL(first, last, __FILEW__, __LINE__)
#define _DEBUG_ORDER_PRED(first, last, pred) _DEBUG_ORDER_IMPL(first, last, pred, __FILEW__, __LINE__)
...
#define _DEBUG_POINTER(first) _Debug_pointer(first, __FILEW__, __LINE__)
#define _DEBUG_POINTER2(first, filew, line) _Debug_pointer(first, filew, line)
#define _DEBUG_RANGE(first, last) _Debug_range(first, last, __FILEW__, __LINE__)
#define _DEBUG_RANGE2(first, last, filew, line) _Debug_range(first, last, filew, line)

// TEMPLATE FUNCTION _Debug_pointer
template <class _InIt>
inline void __CLRCALL_OR_CDECL _Debug_pointer(_InIt &, const wchar_t *, unsigned int)
{  // test pointer for non-singularity, arbitrary type
}

#if 1310 <= _MSC_VER
template <class _Ty>
inline void __CLRCALL_OR_CDECL _Debug_pointer(const _Ty *_First, const wchar_t *_File, unsigned int _Line)
...
template <class _Ty>
inline void __CLRCALL_OR_CDECL _Debug_pointer(_Ty *_First, const wchar_t *_File, unsigned int _Line)
...
template <class _InIt>
inline void __CLRCALL_OR_CDECL _Debug_range2(_InIt, _InIt, const wchar_t *, unsigned int, input_iterator_tag)
{  // test iterator pair for valid range, arbitrary iterators
}

template <class _RanIt>
inline void __CLRCALL_OR_CDECL _Debug_range2(_RanIt _First, _RanIt _Last, const wchar_t *_File, unsigned int _Line,
                                             random_access_iterator_tag)
{                           // test iterator pair for valid range, random-access iterators
    if (_First != _Last) {  // check for non-null pointers, valid range
...
template <class _InIt>
inline void __CLRCALL_OR_CDECL _Debug_range(_InIt _First, _InIt _Last, const wchar_t *_File, unsigned int _Line)
...
template <class _InIt>
inline void __CLRCALL_OR_CDECL _Debug_order2(_InIt _First, _InIt _Last, const wchar_t *_File, unsigned int _Line,
                                             input_iterator_tag)
{  // test if range is ordered by operator<, input iterators
}

template <class _FwdIt>
inline void __CLRCALL_OR_CDECL _Debug_order2(_FwdIt _First, _FwdIt _Last, const wchar_t *_File, unsigned int _Line,
...
template <class _InIt>
inline void __CLRCALL_OR_CDECL _Debug_order(_InIt _First, _InIt _Last, const wchar_t *_File, unsigned int _Line)
...
inline void __CLRCALL_OR_CDECL _Debug_order2(_InIt _First, _InIt _Last, _Pr _Pred, const wchar_t *_File,
                                             unsigned int _Line, input_iterator_tag)
{  // test if range is ordered by predicate, input iterators
}

template <class _FwdIt, class _Pr>
inline void __CLRCALL_OR_CDECL _Debug_order2(_FwdIt _First, _FwdIt _Last, _Pr _Pred, const wchar_t *_File,
                                             unsigned int _Line, forward_iterator_tag)
...
template <class _InIt, class _Pr>
inline void __CLRCALL_OR_CDECL _Debug_order(_InIt _First, _InIt _Last, _Pr _Pred, const wchar_t *_File,
                                            unsigned int _Line)
...
template <class _InIt>
inline void __CLRCALL_OR_CDECL _Debug_order_single2(_InIt _First, _InIt _Last, bool _IsFirstIteration,
...
template <class _FwdIt>
inline void __CLRCALL_OR_CDECL _Debug_order_single2(_FwdIt _First, _FwdIt _Last, bool /* _IsFirstIteration */,
...
template <class _InIt>
inline void __CLRCALL_OR_CDECL _Debug_order_single(_InIt _First, _InIt _Last, bool _IsFirstIteration,
...
template <class _InIt, class _Pr>
inline void __CLRCALL_OR_CDECL _Debug_order_single2(_InIt _First, _InIt _Last, _Pr _Pred, bool _IsFirstIteration,
                                                    const wchar_t *_File, unsigned int _Line, input_iterator_tag)
{  // test if _First and ++_First ordered by predicate, input iterators
}

template <class _FwdIt, class _Pr>
inline void __CLRCALL_OR_CDECL _Debug_order_single2(_FwdIt _First, _FwdIt _Last, _Pr _Pred, bool _IsFirstIteration,
                                                    const wchar_t *_File, unsigned int _Line, forward_iterator_tag)
...
template <class _InIt, class _Pr>
inline void __CLRCALL_OR_CDECL _Debug_order_single(_InIt _First, _InIt _Last, _Pr _Pred, bool _IsFirstIteration,
                                                   const wchar_t *_File, unsigned int _Line)
...
template <class _Iter>
inline typename iterator_traits<_Iter>::value_type *__CLRCALL_OR_CDECL _Val_type(_Iter)
...
inline void __CLRCALL_OR_CDECL advance(_InIt &_Where, _Diff _Off)
{  // increment iterator by offset, arbitrary iterators
    _Advance(_Where, _Off, _Iter_cat(_Where));
}

template <class _InIt, class _Diff>
inline void __CLRCALL_OR_CDECL _Advance(_InIt &_Where, _Diff _Off, input_iterator_tag)
...
inline void __CLRCALL_OR_CDECL _Advance(_FI &_Where, _Diff _Off, forward_iterator_tag)
...
inline void __CLRCALL_OR_CDECL _Advance(_BI &_Where, _Diff _Off, bidirectional_iterator_tag)
...
inline void __CLRCALL_OR_CDECL _Advance(_RI &_Where, _Diff _Off, random_access_iterator_tag)
...
template <class _Iter>
inline typename iterator_traits<_Iter>::difference_type *__CLRCALL_OR_CDECL _Dist_type(_Iter)
...
template <class _InIt, class _Diff>
inline void __CLRCALL_OR_CDECL _Distance2(_InIt _First, _InIt _Last, _Diff &_Off, input_iterator_tag)
...
inline void __CLRCALL_OR_CDECL _Distance2(_FwdIt _First, _FwdIt _Last, _Diff &_Off, forward_iterator_tag)
...
inline void __CLRCALL_OR_CDECL _Distance2(_BidIt _First, _BidIt _Last, _Diff &_Off, bidirectional_iterator_tag)
...
inline void __CLRCALL_OR_CDECL _Distance2(_RanIt _First, _RanIt _Last, _Diff &_Off, random_access_iterator_tag)
{  // add to _Off distance between random-access iterators

#if _HAS_ITERATOR_DEBUGGING
    if (_First != _Last) {  // check for null pointers
...
template <class _InIt>
inline typename iterator_traits<_InIt>::difference_type __CLRCALL_OR_CDECL distance(_InIt _First, _InIt _Last)
...
template <class _InIt, class _Diff>
inline void __CLRCALL_OR_CDECL _Distance(_InIt _First, _InIt _Last, _Diff &_Off)
...
template <class _RanIt>
class reverse_iterator : public _Iterator_base_secure {  // wrap iterator to run it backwards
public:
    ...
    explicit __CLR_OR_THIS_CALL reverse_iterator(_RanIt _Right) : current(_Right)
    {  // construct wrapped iterator from _Right
    }

    template <class _Other>
    __CLR_OR_THIS_CALL reverse_iterator(const reverse_iterator<_Other> &_Right) : current(_Right.base())
...
template <class _RanIt, class _Diff>
inline reverse_iterator<_RanIt> __CLRCALL_OR_CDECL operator+(_Diff _Off, const reverse_iterator<_RanIt> &_Right)
{  // return reverse_iterator + integer
    return (_Right + _Off);
}

template <class _RanIt1, class _RanIt2>
inline typename reverse_iterator<_RanIt1>::difference_type __CLRCALL_OR_CDECL
operator-(const reverse_iterator<_RanIt1> &_Left, const reverse_iterator<_RanIt2> &_Right)
{  // return difference of reverse_iterators
    return (_Left._Minus(_Right));
}

template <class _RanIt1, class _RanIt2>
inline bool __CLRCALL_OR_CDECL operator==(const reverse_iterator<_RanIt1> &_Left,
...
class reverse_bidirectional_iterator : public iterator<bidirectional_iterator_tag, _Ty, _Diff, _Pointer,
                                                       _Reference> {  // wrap bidirectional iterator to run it backwards
public:
    ...
    explicit __CLR_OR_THIS_CALL reverse_bidirectional_iterator(_BidIt _Right) : current(_Right)
    {  // construct wrapped iterator from _Right
    }
...
class _Revbidit
    : public iterator<typename iterator_traits<_BidIt>::iterator_category, typename iterator_traits<_BidIt>::value_type,
                      typename iterator_traits<_BidIt>::difference_type, typename iterator_traits<_BidIt>::pointer,
                      typename iterator_traits<_BidIt>::reference> {  // wrap bidirectional iterator to run it backwards
public:
    ...
    explicit __CLR_OR_THIS_CALL _Revbidit(_BidIt _Right) : current(_Right)
    {  // construct wrapped iterator from _Right
    }

    __CLR_OR_THIS_CALL _Revbidit(const _Revbidit<_BidIt2> &_Other) : current(_Other.base())
...
inline _OutIt __CLRCALL_OR_CDECL _Copy_opt(_InIt _First, _InIt _Last, _OutIt _Dest, _InOutItCat,
...
inline _OutIt __CLRCALL_OR_CDECL _Copy_opt(_InIt _First, _InIt _Last, _OutIt _Dest, random_access_iterator_tag,
                                           _Nonscalar_ptr_iterator_tag, _Range_checked_iterator_tag)
...
template <class _InIt, class _OutIt>
inline _IF_CHK(_OutIt) __CLRCALL_OR_CDECL copy(_InIt _First, _InIt _Last, _OutIt _Dest)
{  // copy [_First, _Last) to [_Dest, ...)
    return (_Copy_opt(_CHECKED_BASE(_First),
                      _CHECKED_BASE(_Last),
                      _Dest,
...
template <class _InIt, class _OutIt>
inline _SCL_INSECURE_DEPRECATE _IF_NOT_CHK(_OutIt)
__CLRCALL_OR_CDECL copy(_InIt _First, _InIt _Last, _OutIt _Dest)
{  // copy [_First, _Last) to [_Dest, ...)
    return (_Copy_opt(_CHECKED_BASE(_First),
                      _CHECKED_BASE(_Last),
                      _Dest,
...
template <class _InIt, class _OutIt>
inline _OutIt __CLRCALL_OR_CDECL copy(_InIt _First, _InIt _Last, _OutIt _Dest)
{  // copy [_First, _Last) to [_Dest, ...)
    return (_Copy_opt(_CHECKED_BASE(_First),
                      _CHECKED_BASE(_Last),
                      _Dest,
...
inline _OutIt __CLRCALL_OR_CDECL _Move_opt(_InIt _First, _InIt _Last, _OutIt _Dest, _InOutItCat _First_dest_cat,
                                           _MoveCatTy, _Range_checked_iterator_tag)
...
template <class _InIt, class _OutIt, class _InOutItCat>
inline _OutIt __CLRCALL_OR_CDECL _Move_opt(_InIt _First, _InIt _Last, _OutIt _Dest, _InOutItCat, _Swap_move_tag,
                                           _Range_checked_iterator_tag)
...
#if _SECURE_SCL
template <class _InIt, class _OutIt, class _InOutItCat>
inline _OutIt __CLRCALL_OR_CDECL _Move_opt(_InIt _First, _InIt _Last, _OutIt _Dest, random_access_iterator_tag,
                                           _Swap_move_tag _Move_cat, _Range_checked_iterator_tag)
{  // use swap to instead of the copy constructor
    // if _OutIt is range checked, this will make sure there is enough space for the copy
    _OutIt _Result = _Dest + (_Last - _First);
    _Move_opt(_First, _Last, _CHECKED_BASE(_Dest), forward_iterator_tag(), _Move_cat, _Range_checked_iterator_tag());
    return _Result;
}
#endif
...
template <class _InIt, class _OutIt>
inline _IF_CHK(_OutIt) __CLRCALL_OR_CDECL _Move(_InIt _First, _InIt _Last, _OutIt _Dest)
{  // move [_First, _Last) to [_Dest, ...)
    return _Move_opt(_CHECKED_BASE(_First),
                     _CHECKED_BASE(_Last),
                     _Dest,
                     _Iter_random(_First, _Dest),
                     _Move_cat(_Dest),
...
template <class _InIt, class _OutIt>
inline _SCL_INSECURE_DEPRECATE _IF_NOT_CHK(_OutIt)
__CLRCALL_OR_CDECL _Move(_InIt _First, _InIt _Last, _OutIt _Dest)
{  // move [_First, _Last) to [_Dest, ...)
    return _Move_opt(_CHECKED_BASE(_First),
                     _CHECKED_BASE(_Last),
                     _Dest,
...
template <class _InIt, class _OutIt>
inline _OutIt __CLRCALL_OR_CDECL _Move(_InIt _First, _InIt _Last, _OutIt _Dest)
{  // move [_First, _Last) to [_Dest, ...)
    return _Move_opt(_CHECKED_BASE(_First),
                     _CHECKED_BASE(_Last),
                     _Dest,
...
inline _BidIt2 __CLRCALL_OR_CDECL _Copy_backward_opt(_BidIt1 _First, _BidIt1 _Last, _BidIt2 _Dest, _InOutItCat,
                                                     _Nonscalar_ptr_iterator_tag, _Range_checked_iterator_tag)
...
#if _SECURE_SCL
template <class _InIt, class _OutIt>
inline _OutIt __CLRCALL_OR_CDECL _Copy_backward_opt(_InIt _First, _InIt _Last, _OutIt _Dest, random_access_iterator_tag,
                                                    _Nonscalar_ptr_iterator_tag, _Range_checked_iterator_tag)
{  // copy [_First, _Last) backwards to [..., _Dest), arbitrary iterators
    // if _OutIt is range checked, this will make sure there is enough space for the copy
    _OutIt _Result = _Dest - (_Last - _First);
    _Copy_backward_opt(_First,
                       _Last,
                       _CHECKED_BASE(_Dest),
                       forward_iterator_tag(),
                       _Nonscalar_ptr_iterator_tag(),
...
template <class _InIt, class _OutIt, class _InOutItCat>
inline _OutIt __CLRCALL_OR_CDECL _Copy_backward_opt(_InIt _First, _InIt _Last, _OutIt _Dest, _InOutItCat,
                                                    _Scalar_ptr_iterator_tag, _Range_checked_iterator_tag)
...
inline _IF_CHK(_BidIt2) __CLRCALL_OR_CDECL copy_backward(_BidIt1 _First, _BidIt1 _Last, _BidIt2 _Dest)
{  // copy [_First, _Last) backwards to [..., _Dest)
    return _Copy_backward_opt(_CHECKED_BASE(_First),
                              _CHECKED_BASE(_Last),
                              _Dest,
                              _Iter_random(_First, _Dest),
                              _Ptr_cat(_First, _Dest),
...
template <class _BidIt1, class _BidIt2>
inline _SCL_INSECURE_DEPRECATE _IF_NOT_CHK(_BidIt2)
__CLRCALL_OR_CDECL copy_backward(_BidIt1 _First, _BidIt1 _Last, _BidIt2 _Dest)
{  // copy [_First, _Last) backwards to [..., _Dest)
    return _Copy_backward_opt(_CHECKED_BASE(_First),
                              _CHECKED_BASE(_Last),
                              _Dest,
...
template <class _BidIt1, class _BidIt2>
inline _BidIt2 __CLRCALL_OR_CDECL copy_backward(_BidIt1 _First, _BidIt1 _Last, _BidIt2 _Dest)
{  // copy [_First, _Last) backwards to [..., _Dest)
    return _Copy_backward_opt(_CHECKED_BASE(_First),
                              _CHECKED_BASE(_Last),
                              _Dest,
...
inline _BidIt2 __CLRCALL_OR_CDECL _Move_backward_opt(_BidIt1 _First, _BidIt1 _Last, _BidIt2 _Dest,
                                                     _InOutItCat _First_dest_cat, _MoveCatTy,
                                                     _Range_checked_iterator_tag)
{  // move defaults to copy if there is not a more effecient way
    return _Copy_backward_opt(
        _First, _Last, _Dest, _First_dest_cat, _Ptr_cat(_First, _Dest), _Range_checked_iterator_tag());
}

template <class _BidIt1, class _BidIt2, class _InOutItCat>
inline _BidIt2 __CLRCALL_OR_CDECL _Move_backward_opt(_BidIt1 _First, _BidIt1 _Last, _BidIt2 _Dest, _InOutItCat,
                                                     _Swap_move_tag, _Range_checked_iterator_tag)
...
template <class _BidIt1, class _BidIt2>
inline _BidIt2 __CLRCALL_OR_CDECL _Move_backward_opt(_BidIt1 _First, _BidIt1 _Last, _BidIt2 _Dest,
                                                     random_access_iterator_tag, _Swap_move_tag _Move_cat,
                                                     _Range_checked_iterator_tag)
{  // use swap to instead of the copy constructor
    // if _OutIt is range checked, this will make sure there is enough space for the copy
    _BidIt2 _Result = _Dest - (_Last - _First);
    _Move_backward_opt(
        _First, _Last, _CHECKED_BASE(_Dest), forward_iterator_tag(), _Move_cat, _Range_checked_iterator_tag());
    return _Result;
}
#endif
...
template <class _BidIt1, class _BidIt2>
inline _IF_CHK(_BidIt2) __CLRCALL_OR_CDECL _Move_backward(_BidIt1 _First, _BidIt1 _Last, _BidIt2 _Dest)
{  // move [_First, _Last) backwards to [..., _Dest)
    return _Move_backward_opt(_CHECKED_BASE(_First),
                              _CHECKED_BASE(_Last),
                              _Dest,
                              _Iter_random(_First, _Dest),
                              _Move_cat(_Dest),
...
template <class _BidIt1, class _BidIt2>
inline _SCL_INSECURE_DEPRECATE _IF_NOT_CHK(_BidIt2)
__CLRCALL_OR_CDECL _Move_backward(_BidIt1 _First, _BidIt1 _Last, _BidIt2 _Dest)
{  // move [_First, _Last) backwards to [..., _Dest)
    return _Move_backward_opt(_CHECKED_BASE(_First),
                              _CHECKED_BASE(_Last),
                              _Dest,
...
template <class _BidIt1, class _BidIt2>
inline _BidIt2 __CLRCALL_OR_CDECL _Move_backward(_BidIt1 _First, _BidIt1 _Last, _BidIt2 _Dest)
{  // move [_First, _Last) backwards to [..., _Dest)
    return _Move_backward_opt(_CHECKED_BASE(_First),
                              _CHECKED_BASE(_Last),
                              _Dest,
...
inline std::pair<_InIt1, _InIt2> __CLRCALL_OR_CDECL _Mismatch(_InIt1 _First1, _InIt1 _Last1, _InIt2 _First2, _InItCats,
                                                              _Range_checked_iterator_tag)
...
inline pair<_InIt1, _InIt2> __CLRCALL_OR_CDECL _Mismatch(_InIt1 _First1, _InIt1 _Last1, _InIt2 _First2,
...
{  // return [_First1, _Last1) and [_First2, _Last2) mismatch
    ...
    pair<_InIt1, _CHECKED_BASE_TYPE(_InIt2)> _Result =
        _Mismatch(_First1, _Last1, _CHECKED_BASE(_First2), forward_iterator_tag(), _Range_checked_iterator_tag());
...
{  // return [_First1, _Last1) and [_First2, _Last2) mismatch
    pair<_CHECKED_BASE_TYPE(_InIt1), _InIt2> _Result = _Mismatch(_CHECKED_BASE(_First1),
...
template <class _InIt1, class _InIt2>
inline _SCL_INSECURE_DEPRECATE _IF_NOT_CHK_RET_PAIR(_InIt2, _InIt1, _InIt2)
...
inline std::pair<_InIt1, _InIt2> __CLRCALL_OR_CDECL _Mismatch(_InIt1 _First1, _InIt1 _Last1, _InIt2 _First2, _Pr _Pred,
...
inline pair<_InIt1, _InIt2> __CLRCALL_OR_CDECL _Mismatch(_InIt1 _First1, _InIt1 _Last1, _InIt2 _First2, _Pr _Pred,
                                                         random_access_iterator_tag, _Range_checked_iterator_tag)
{  // return [_First1, _Last1) and [_First2, _Last2) mismatch using _Pred
    // for range checked iterators, this will make sure there is enough space
    _InIt2 _Last2 = _First2 + (_Last1 - _First1);
    (_Last2);
    pair<_InIt1, _CHECKED_BASE_TYPE(_InIt2)> _Result = _Mismatch(
        _First1, _Last1, _CHECKED_BASE(_First2), _Pred, forward_iterator_tag(), _Range_checked_iterator_tag());
    _ASSIGN_FROM_BASE(_First2, _Result.second);
    return (pair<_InIt1, _InIt2>(_Result.first, _First2));
}
#endif
...
template <class _InIt1, class _InIt2, class _InItCats>
inline bool __CLRCALL_OR_CDECL _Equal(_InIt1 _First1, _InIt1 _Last1, _InIt2 _First2, _InItCats,
                                      _Range_checked_iterator_tag)
{  // compare [_First1, _Last1) to [First2, ...)
    return (_Mismatch(_First1, _Last1, _First2, forward_iterator_tag(), _Range_checked_iterator_tag()).first == _Last1);
}

inline bool __CLRCALL_OR_CDECL _Equal(const char *_First1, const char *_Last1, const char *_First2,
                                      random_access_iterator_tag, _Range_checked_iterator_tag)
...
inline bool __CLRCALL_OR_CDECL _Equal(const signed char *_First1, const signed char *_Last1, const signed char *_First2,
                                      random_access_iterator_tag, _Range_checked_iterator_tag)
...
inline bool __CLRCALL_OR_CDECL _Equal(const unsigned char *_First1, const unsigned char *_Last1,
                                      const unsigned char *_First2, random_access_iterator_tag,
                                      _Range_checked_iterator_tag)
...
#if _SECURE_SCL
template <class _InIt1, class _InIt2>
inline bool __CLRCALL_OR_CDECL _Equal(_InIt1 _First1, _InIt1 _Last1, _InIt2 _First2, random_access_iterator_tag,
                                      _Range_checked_iterator_tag)
{
    // for range checked iterators, this will make sure there is enough space
    _InIt2 _Last2 = _First2 + (_Last1 - _First1);
    (_Last2);
    return _Equal(_First1, _Last1, _CHECKED_BASE(_First2), forward_iterator_tag(), _Range_checked_iterator_tag());
}
#endif
...
template <class _InIt1, class _InIt2>
inline _IF_CHK_(_InIt2, bool) __CLRCALL_OR_CDECL equal(_InIt1 _First1, _InIt1 _Last1, _InIt2 _First2)
{  // compare [_First1, _Last1) to [First2, ...)
    return _Equal(_CHECKED_BASE(_First1),
                  _CHECKED_BASE(_Last1),
                  _First2,
                  _Iter_random(_First1, _First2),
                  _STD _Range_checked_iterator_tag());
...
template <class _InIt1, class _InIt2>
inline _SCL_INSECURE_DEPRECATE _IF_NOT_CHK_(_InIt2, bool) __CLRCALL_OR_CDECL
    equal(_InIt1 _First1, _InIt1 _Last1, _InIt2 _First2)
{  // compare [_First1, _Last1) to [First2, ...)
    return _Equal(_CHECKED_BASE(_First1),
                  _CHECKED_BASE(_Last1),
                  _First2,
...
template <class _InIt1, class _InIt2>
inline bool __CLRCALL_OR_CDECL equal(_InIt1 _First1, _InIt1 _Last1, _InIt2 _First2)
{  // compare [_First1, _Last1) to [First2, ...)
    return _Equal(_CHECKED_BASE(_First1),
                  _CHECKED_BASE(_Last1),
                  _First2,
...
template <class _InIt1, class _InIt2, class _Pr, class _InItCats>
inline bool __CLRCALL_OR_CDECL _Equal(_InIt1 _First1, _InIt1 _Last1, _InIt2 _First2, _Pr _Pred, _InItCats,
                                      _Range_checked_iterator_tag)
{  // compare [_First1, _Last1) to [First2, ...) using _Pred
    return (_Mismatch(_First1, _Last1, _First2, _Pred, forward_iterator_tag(), _Range_checked_iterator_tag()).first ==
            _Last1);
}

#if _SECURE_SCL
template <class _InIt1, class _InIt2, class _Pr>
inline bool __CLRCALL_OR_CDECL _Equal(_InIt1 _First1, _InIt1 _Last1, _InIt2 _First2, _Pr _Pred,
                                      random_access_iterator_tag, _Range_checked_iterator_tag)
{
    // for range checked iterators, this will make sure there is enough space
    _InIt2 _Last2 = _First2 + (_Last1 - _First1);
...
template <class _InIt1, class _InIt2, class _Pr>
inline _IF_CHK_(_InIt2, bool) __CLRCALL_OR_CDECL equal(_InIt1 _First1, _InIt1 _Last1, _InIt2 _First2, _Pr _Pred)
{  // compare [_First1, _Last1) to [First2, ...) using _Pred
    return _Equal(_CHECKED_BASE(_First1),
                  _CHECKED_BASE(_Last1),
                  _First2,
...
template <class _InIt1, class _InIt2, class _Pr>
inline _SCL_INSECURE_DEPRECATE _IF_NOT_CHK_(_InIt2, bool) __CLRCALL_OR_CDECL
    equal(_InIt1 _First1, _InIt1 _Last1, _InIt2 _First2, _Pr _Pred)
{  // compare [_First1, _Last1) to [First2, ...) using _Pred
    return _Equal(_CHECKED_BASE(_First1),
                  _CHECKED_BASE(_Last1),
                  _First2,
...
template <class _InIt1, class _InIt2, class _Pr>
inline bool __CLRCALL_OR_CDECL equal(_InIt1 _First1, _InIt1 _Last1, _InIt2 _First2, _Pr _Pred)
{  // compare [_First1, _Last1) to [First2, ...) using _Pred
    return _Equal(_CHECKED_BASE(_First1),
                  _CHECKED_BASE(_Last1),
                  _First2,
...
inline void __CLRCALL_OR_CDECL _Fill(_FwdIt _First, _FwdIt _Last, const _Ty &_Val)
...
inline void __CLRCALL_OR_CDECL _Fill(__out_ecount_full(_Last - _First) char *_First, __in_opt char *_Last, int _Val)
{  // copy char _Val through [_First, _Last)
    _DEBUG_RANGE(_First, _Last);
    ::memset(_First, _Val, _Last - _First);
}

inline void __CLRCALL_OR_CDECL _Fill(__out_ecount_full(_Last - _First) signed char *_First, __in_opt signed char *_Last,
                                     int _Val)
...
inline void __CLRCALL_OR_CDECL _Fill(__out_ecount_full(_Last - _First) unsigned char *_First,
...
template <class _FwdIt, class _Ty>
inline void __CLRCALL_OR_CDECL fill(_FwdIt _First, _FwdIt _Last, const _Ty &_Val)
{  // copy _Val through [_First, _Last)
...
inline void __CLRCALL_OR_CDECL _Fill_n(_OutIt _First, _Diff _Count, const _Ty &_Val, _Range_checked_iterator_tag)
{  // copy _Val _Count times through [_First, ...)
    for (; 0 < _Count; --_Count, ++_First)
        *_First = _Val;
}

inline void __CLRCALL_OR_CDECL _Fill_n(__out_ecount_full_opt(_Count) char *_First, size_t _Count, int _Val,
                                       _Range_checked_iterator_tag)
...
inline void __CLRCALL_OR_CDECL _Fill_n(__out_ecount_full_opt(_Count) signed char *_First, size_t _Count, int _Val,
                                       _Range_checked_iterator_tag)
...
inline void __CLRCALL_OR_CDECL _Fill_n(__out_ecount_full_opt(_Count) unsigned char *_First, size_t _Count, int _Val,
                                       _Range_checked_iterator_tag)
...
inline void __CLRCALL_OR_CDECL _Fill_n(_OutIt _First, _Diff _Count, const _Ty &_Val, _OutCat,
                                       _Range_checked_iterator_tag)
{
...
#if _SECURE_SCL
template <class _OutIt, class _Diff, class _Ty>
inline void __CLRCALL_OR_CDECL _Fill_n(_OutIt _First, _Diff _Count, const _Ty &_Val, random_access_iterator_tag,
                                       _Range_checked_iterator_tag)
{
    // if _OutIt is checked, this will ensure we have enough space
    _OutIt _Last = _First + _Count;
    (_Last);
    _Fill_n(_CHECKED_BASE(_First), _Count, _Val, _Range_checked_iterator_tag());
}
#endif
...
template <class _InIt1, class _InIt2>
inline bool __CLRCALL_OR_CDECL _Lexicographical_compare(_InIt1 _First1, _InIt1 _Last1, _InIt2 _First2, _InIt2 _Last2)
...
template <class _InIt1, class _InIt2>
inline bool __CLRCALL_OR_CDECL lexicographical_compare(_InIt1 _First1, _InIt1 _Last1, _InIt2 _First2, _InIt2 _Last2)
{  // order [_First1, _Last1) vs. [First2, Last2)
    return _Lexicographical_compare(
        _CHECKED_BASE(_First1), _CHECKED_BASE(_Last1), _CHECKED_BASE(_First2), _CHECKED_BASE(_Last2));
}

inline bool __CLRCALL_OR_CDECL lexicographical_compare(const unsigned char *_First1, const unsigned char *_Last1,
...
inline bool __CLRCALL_OR_CDECL lexicographical_compare(const char *_First1, const char *_Last1, const char *_First2,
                                                       const char *_Last2)
...
{  // order [_First1, _Last1) vs. [First2, Last2) using _Pred
    return _Lexicographical_compare(
        _CHECKED_BASE(_First1), _CHECKED_BASE(_Last1), _CHECKED_BASE(_First2), _CHECKED_BASE(_Last2), _Pred);
}
...
template <class _Ty>
inline const _Ty &(__CLRCALL_OR_CDECL _IMPL_MAX)(const _Ty &_Left, const _Ty &_Right)
...
inline const _Ty &(__CLRCALL_OR_CDECL _IMPL_MAX)(const _Ty &_Left, const _Ty &_Right, _Pr _Pred)
...
template <class _Ty>
inline const _Ty &(__CLRCALL_OR_CDECL _IMPL_MIN)(const _Ty &_Left, const _Ty &_Right)
...
template <class _Ty, class _Pr>
inline const _Ty &(__CLRCALL_OR_CDECL _IMPL_MIN)(const _Ty &_Left, const _Ty &_Right, _Pr _Pred)
