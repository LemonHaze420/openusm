...
public:
    ...
    typedef typename std::allocator_traits<_Alloc>::template rebind_alloc<value_type> allocator_type;
    ...
    enum {  // make multi parameter visible as an enum constant
        _Multi = _Mfl
    };
    ...
    _Hmap_traits(const _Tr &_Traits) : comp(_Traits)
    ...
    public:
        ...
        value_compare(const key_compare &_Traits) : comp(_Traits)
...
template <class _Kty, class _Ty, class _Tr = hash_compare<_Kty, std::less<_Kty>>,
...
public:
    ...
    template <class _Iter>
    hash_map(_Iter _First, _Iter _Last, const key_compare &_Traits, const allocator_type &_Al) : _Mybase(_Traits, _Al)
...
template <class _Kty, class _Ty, class _Tr = hash_compare<_Kty, std::less<_Kty>>,
          class _Alloc = std::allocator<std::pair<const _Kty, _Ty>>>
class hash_multimap
    : public _Hash<_Hmap_traits<_Kty, _Ty, _Tr, _Alloc, true>> {  // hash table of {key, mapped} values, non-unique keys
public:
