...
float sub_4ADC40(float a1)
{
    ...
    if (a1 >= 0.5f) {
        ...
        result = v3 * v3 * v3 * (v3 * v3) * (v3 * v3) * flt_880AEC - v3 * v3 * v3 * (v3 * v3) * flt_880AE8 -
                 v3 * v3 * v3 * flt_880AE4 - (v3 + v3) + half_PI;
    } else {
        auto v1 = a1 * a1;
        result = v1 * (a1 * v1 * v1) * flt_880AF8 + a1 * v1 * v1 * flt_880AF4 + a1 * v1 * flt_880AF0 + a1;
    }
...
float sub_48C0C0(const float &a1, const float &a2, const float &a3, const float &a4, const float &a5)
{
    if (equal(a3, a2)) {
        return a4;
    }
...
float calculate_xz_angle_relative_to_local_po(const vector3d &a1, [[maybe_unused]] const vector3d &a2,
                                              const vector3d &a3, const vector3d &a4, const vector3d &a5)
{
    auto v5 = -dot(a4, a1);
    auto v6 = dot(a4, a3);
    auto v7 = -dot(a5, a1);
...
double calculate_xz_angle_relative_to_local_po(const po &a1, const vector3d &a4, const vector3d &a5)
{
