...
//0x0056AE30
template <>
int mAvlTree<string_hash_entry>::addHelper(mAvlNode<string_hash_entry> *a2, mAvlNode<string_hash_entry> *&a3,
...
template <>
void mAvlNode<string_hash_entry>::unmash(mash_info_struct *a3, void *)
{
