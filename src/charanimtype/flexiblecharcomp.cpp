...
template <>
void FlexibleCharComp<FakerootPoseDesc, FakerootEntCompDecomp<FakerootPoseDesc>>::_CalcPoseDataDirect(
    void *a2, uint32_t a3, Float a4, Float a5, const nalComp::nalCompAnim *a6, const void *a7, const void *a8,
    const void *a9, void *a10)
{
    TRACE("FlexibleCharComp<FakerootPoseDesc,FakerootEntCompDecomp<FakerootPoseDesc>>::CalcPoseDataDirect");

    if constexpr (1) {
        this->field_15.GetPose(static_cast<FakerootPoseDesc::StdPoseData *>(a2),
                               a3,
                               a4,
                               a5,
...
template <>
void FlexibleCharComp<LegsIKPoseDesc, LegsIKEntCompDecomp<LegsIKPoseDesc>>::_CalcPoseDataDirect(
    void *a2, uint32_t a3, Float a4, Float a5, const nalComp::nalCompAnim *a6, const void *a7, const void *a8,
    const void *a9, void *a10)
{
    TRACE("FlexibleCharComp<LegsIKPoseDesc,LegsIKEntCompDecomp<LegsIKPoseDesc>>::CalcPoseDataDirect");

    if constexpr (1) {
        this->field_15.GetPose(static_cast<LegsIKPoseDesc::StdPoseData *>(a2),
                               a3,
                               a4,
                               a5,
                               bit_cast<const nalChar::nalCharAnim *>(a6),
                               bit_cast<const LegsIKPoseDesc::PerSkelData *>(a7),
                               bit_cast<const LegsIKPoseDesc::PerAnimData *>(a8),
                               a9,
                               static_cast<LegsIKEntCompDecomp<LegsIKPoseDesc>::PerInstData *>(a10),
                               &this->field_14);
    } else {
