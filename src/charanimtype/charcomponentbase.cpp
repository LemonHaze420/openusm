...
int CharComponentBase::_DoesContributeToPose(uint32_t, const void *, const void *)
{
...
int CharComponentBase::_GetSizeOfPerInstData(uint32_t a2, const void *a3, const void *a4, const void *a5,
                                             const void *a6, const void *a7, bool bIsRemapped)
{
    ...
    if constexpr (1) {
        ...
        int(__fastcall * func)(
            void *, void *edx, uint32_t, const void *, const void *, const void *, const void *, const void *, bool) =
            CAST(func, 0x005EC4E0);
        return func(this, nullptr, a2, a3, a4, a5, a6, a7, bIsRemapped);
    }
}

int CharComponentBase::_GetAlignOfPerInstData(uint32_t a2, const void *a3, const void *a4, const void *a5,
                                              const void *a6, const void *a7, bool bIsRemapped)
{
    ...
    if constexpr (0) {
        ...
        return int(
            this->m_pSubComponent->GetTrajectoryData(bit_cast<nalPositionOrientation *>(a3), (uint32_t)a4, a5, a6));
    } else {
        int(__fastcall * func)(
            void *, void *edx, uint32_t, const void *, const void *, const void *, const void *, const void *, bool) =
            CAST(func, 0x005EC510);
        return func(this, nullptr, a2, a3, a4, a5, a6, a7, bIsRemapped);
    }
}

void CharComponentBase::_BuildPerInstData(void *a2, uint32_t, const void *a4, const void *a5, const void *a6,
                                          const void *, const void *, bool bIsRemapped)
{
    ...
    this->m_pSubComponent->BuildBoneMatrices((nalMatrix4x4 *)a2, (uint32_t)a4, a5, a6);
}

void *CharComponentBase::_CalcPoseDataDirect(void *a2, uint32_t, Float a4, Float a5, const nalComp::nalCompAnim *a6,
                                             const void *a7, const void *a8, const void *a9, void *)
{
    ...
    return bit_cast<void *>(this->m_pSubComponent->GetSizeOfPerInstData(
        bit_cast<uint32_t>(a2), bit_cast<const void *>(a4), bit_cast<const void *>(a5), a6, a7, a8, (bool)a9));
}
...
uint32_t CharComponentBase::GetPoseTypeID() const
{
    uint32_t(__fastcall * func)(const void *) = CAST(func, get_vfunc(m_vtbl, 0x58));
    return func(this);
}

int CharComponentBase::_GetRemapSizeOfPerInstData(uint32_t, uint32_t, const CharComponentBase *, const void *,
                                                  const void *, const void *, const void *, const void *)
{
    return 0;
}

int CharComponentBase::GetRemapSizeOfPerInstData(uint32_t a1, uint32_t a2, const CharComponentBase *a3, const void *a4,
                                                 const void *a5, const void *a6, const void *a7, const void *a8)
{
    int(__fastcall * func)(void *,
                           void *edx,
                           uint32_t,
                           uint32_t a2,
...
int CharComponentBase::_GetRemapAlignOfPerInstData(uint32_t, uint32_t, const CharComponentBase *, const void *,
                                                   const void *, const void *, const void *, const void *)
{
    return 0;
}

int CharComponentBase::GetRemapAlignOfPerInstData(uint32_t a2, uint32_t a3, const CharComponentBase *a4, const void *a5,
...
void CharComponentBase::BuildRemapPerInstData(void *a2, uint32_t a3, uint32_t a4, const CharComponentBase *a5,
                                              const void *a6, const void *a7, const void *a8, const void *a9,
                                              const void *a10)
{
...
void CharComponentBase::DestroyRemapPerInstData(void *a2, uint32_t a3, uint32_t a4, const CharComponentBase *a5,
                                                const void *a6, const void *a7)
{
    void *(__fastcall *
           func)(void *, void *edx, void *, uint32_t, uint32_t, const CharComponentBase *, const void *, const void *) =
        CAST(func, get_vfunc(m_vtbl, 0x68));

    func(this, nullptr, a2, a3, a4, a5, a6, a7);
}

void CharComponentBase::CalcPoseDataRemapped(void *a1, uint32_t a2, Float a3, Float a4, const nalComp::nalCompAnim *a5,
                                             const void *a6, uint32_t a7, uint32_t a8, const void *a9, const void *a10,
                                             const void *a11, const void *a12, void *a13)
{
    void *(__fastcall * func)(void *,
                              void *edx,
                              void *,
                              ...
                              const void *,
                              const void *,
                              void *) = CAST(func, get_vfunc(m_vtbl, 0x6C));
    func(this, nullptr, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, a13);
}
...
void *CharComponentBase::_AllocTempPoseData(uint32_t, const void *, const void *)
{
    return nullptr;
}
...
{
    void *(__fastcall * func)(void *, void *, uint32_t, const void *, const void *) =
