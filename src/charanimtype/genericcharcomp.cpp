...
void GenericCharComp::BuildBoneMatrices(nalMatrix4x4 *a1, uint32_t, const void *a3, const void *a4)
{
    bit_cast<const nalGeneric::nalGenericSkeleton *>(a3)->GetBoneMatrices(
        bit_cast<const nalGeneric::nalGenericPose *>(a4), a1);
}

void GenericCharComp::CalcPoseDataDirect(void *a3, uint32_t, Float arg8, Float a5, const nalComp::nalCompAnim *,
                                         const void *, const void *, const void *, void *a10)
{
    ...
    static_cast<nalGeneric::nalGenericInstance *>(a10)->GetPose(
        arg8, a5, *static_cast<nalGeneric::nalGenericPose *>(a3), a1);
}
