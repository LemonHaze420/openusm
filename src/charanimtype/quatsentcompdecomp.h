...
struct QuatsEntCompDecomp {
    ...
    void RetrievePoseFromInst(
        T::StdPoseData &a1,
        QuatsEntCompDecomp<T>::PerInstData *a2,
        const T::PerAnimData *a3);

    void AdvanceAnimDataOneFrame(
            QuatsEntCompDecomp<T>::PerInstData *a1,
    ...
    void GetPose(
            ...
            const T::PerSkelData *a6,
            const T::PerAnimData *a7,
            const void *a8,
            QuatsEntCompDecomp<T>::PerInstData *a9,
            const T &a10);
};
