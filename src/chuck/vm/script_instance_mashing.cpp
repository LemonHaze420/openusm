...
void script_instance_info::un_mash(generic_mash_header *a2, void *a3, generic_mash_data_ptrs *a4)
{
    if constexpr (0) {
    } else {
        void(__fastcall * func)(void *, void *edx, generic_mash_header *, void *, generic_mash_data_ptrs *) =
            CAST(func, 0x00599780);
...
bool script_instance_info::initialize_single(const script_executable *a2, string_hash a3, const po &a4)
{
    if constexpr (0) {
        ...
        bool(__fastcall * func)(void *, void *edx, const script_executable *, string_hash, const po *) =
            CAST(func, 0x005ABB00);
