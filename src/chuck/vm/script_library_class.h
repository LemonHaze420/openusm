...
struct script_library_class {
    struct function {
        ...
        //0x006794B0
        /* virtual */ bool operator()(vm_stack &a2, script_library_class::function::entry_t a3) const;
    ...
    //0x005AA860
    script_library_class(const char *a2, int a3, const char *a4, bool a5);
...
extern void verify_parms_integrity(script_library_class::function *func, vm_stack *the_stack, unsigned int *parms,
                                   int parms_size);
...
#define SLF_RECALL return false
