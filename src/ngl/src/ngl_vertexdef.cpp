...
void nglVertexDef_MultipassMesh<nglVertexDef_PCUV_Base>::Iterator::Write(vector3d a2, int color, vector2d a4)
{
    ...
    if constexpr (1)
    {
        struct {
            ...
            float field_C[2];
            uint32_t field_14;
        } *v5 = CAST(v5, int(this->field_4->field_4->field_3C.getVertexData()) + this->field_4->field_4->field_4C) + this->field_8;
        v5->field_0 = a2;
        v5->field_C[0] = a4[0];
        v5->field_C[1] = a4[1];
        v5->field_14 = color;
...
void sub_733030(nglVertexDef_MultipassMesh<nglVertexDef_PCUV_Base>::Iterator *iter, const vector4d &a2, const vector4d &a3, const vector4d &a4, const vector4d &a5, int a6, int p_color)
{
    ...
    *(DWORD *)v24->field_14 = p_color;
    ...
    VertexData *v29 = CAST(v29, iter->field_4->field_4->field_3C.getVertexData() + 0x18 * v25 + iter->field_4->field_4->field_4C);
