...
template<>
nglMorphSet * tlResourceDirectory<nglMorphSet, tlHashString>::StandardLoad(
        const tlHashString &)
{
    return nullptr;
}
...
template<>
nalSceneAnim * tlResourceDirectory<nalSceneAnim, tlFixedString>::StandardLoad(
        const tlFixedString &a2)
{
    char Dest[256] {};
    tlFileBuf a1 {};
...
template<>
nalAnimClass<nalAnyPose> * tlResourceDirectory<nalAnimClass<nalAnyPose>, tlFixedString>::StandardLoad(
        const tlFixedString &)
{
    return nullptr;
}
...
template<>
nglPaletteFile * tlResourceDirectory<nglPaletteFile,tlFixedString>::StandardLoad(
        const tlFixedString &a2)
{
    char Dest[256] {};
...
template<>
int tlResourceDirectory<nglMorphSet,tlHashString>::StandardRelease(
        nglMorphSet *,
        int,
        bool)
{
...
template<>
int tlResourceDirectory<nglMorphFile, tlFixedString>::StandardRelease(
        nglMorphFile *a2,
        int a3,
        bool a4)
{
...
template<>
int tlResourceDirectory<nglMeshFile,tlFixedString>::StandardRelease(
        nglMeshFile *a2,
        int a3,
        bool)
{
...
template<>
int tlResourceDirectory<nglMesh, tlHashString>::StandardRelease(
        nglMesh *,
        int,
        bool)
{
...
template<>
int tlResourceDirectory<nalSceneAnim,tlFixedString>::StandardRelease(
        nalSceneAnim *a1,
        int a3,
        bool)
{
...
template<>
int tlResourceDirectory<nglPaletteFile,tlFixedString>::StandardRelease(
        nglPaletteFile *a2,
        int a3,
        bool)
{
...
template<>
int tlResourceDirectory<nalAnimFile,tlFixedString>::StandardRelease(
        nalAnimFile *a2,
        int a3,
        bool)
{
...
template<>
int tlResourceDirectory<nalAnimClass<nalAnyPose>, tlFixedString>::StandardRelease(
