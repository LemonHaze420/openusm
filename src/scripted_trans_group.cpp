                                            ...
                                            als_data a4, string_hash a5) const
{
    ...
    if constexpr (0) {
        ...
        case IMPLICIT: {
            ...
            auto it = std::find_if(begin, end, [&a4](auto &trans_rule) { return trans_rule->can_transition(a4); });
        ...
        case EXPLICIT: {
            ...
            auto it =
                std::find_if(begin, end, [&a4, &a5](auto &trans_rule) { return trans_rule->can_transition(a4, a5); });
