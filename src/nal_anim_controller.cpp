...
nal_anim_controller::scene_anim_client::CreateInstance(nalAnimClass<nalAnyPose> *a2)
{
    ...
    if constexpr (1) {
        ...
        if (!v2->is_same_animtype(v9)) {
            ...
            error("Attempted to play an animation from a cutscene (anim name: \"%s\") of animtype \"%s\" on a "
...
void nal_anim_controller::scene_anim_client::Render(nalAnimClass<nalAnyPose>::nalInstanceClass *, Float)
{
...
nal_anim_controller::nal_anim_controller(actor *a2, nalBaseSkeleton *a3, unsigned int a4,
        ...
        void *pParameter)
{
    ...
    if constexpr (1) {
        ...
        return v8->create_anim_inst(a2, my_als, als_layer_internal);
    } else {
        void *(__fastcall * func)(void *, void *edx, nalAnimClass<nalAnyPose> *, nalBaseSkeleton *, void *) =
            CAST(func, 0x004A6050);
