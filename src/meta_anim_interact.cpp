...
namespace ai
{
    ...
    strength_test_anim_inst * meta_anim_strength_test::_create_anim_inst(
            nalBaseSkeleton *a2,
            nalAnimClass<nalAnyPose> *,
            als::animation_logic_system *,
            als::state_machine *)
    {
        return new ai::strength_test_anim_inst {
            this->field_28,
            this->field_2C,
            a2,
            this->field_34
    ...
    strength_test_anim_inst::strength_test_anim_inst(
            ...
            nalBaseSkeleton *a4,
            ai::ai_core *a5) : nalAnimClass<nalAnyPose>::nalInstanceClass(a2, a4)
    {
        if constexpr (1) {
            static void * g_vtbl[] {
                nullptr,
...
namespace als
{
    ...
    als_meta_linear_blend::nalInstance * als_meta_linear_blend::_create_anim_inst(
            nalBaseSkeleton *a2,
            nalAnimClass<nalAnyPose> *,
    ...
    als_meta_linear_blend::nalInstance::nalInstance(
            als::als_meta_linear_blend *a2,
            nalBaseSkeleton *a3,
            als::animation_logic_system *a4,
            als::state_machine *a5) : nalAnimClass<nalAnyPose>::nalInstanceClass(a2->get_anim_proxy(), a3)
    {
        if constexpr (0) {
        } else {
