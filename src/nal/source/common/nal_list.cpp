...
nalInitListAnimType::nalInitListAnimType(const char *str, std::intptr_t anim_vtbl_ptr_arg,
...
void nalInitListInit()
{
    ...
    for (nalInitList *v0 = static_cast<decltype(v0)>(nalInitList::head); v0 != nullptr;
