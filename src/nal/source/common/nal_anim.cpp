...
template <>
nalAnimClass<nalAnyPose>::nalInstanceClass::nalInstanceClass(nalAnimClass<nalAnyPose> *a2, nalBaseSkeleton *a3)
{
...
template <>
void nalAnimClass<nalAnyPose>::nalInstanceClass::finalize(bool a2)
{
...
template <>
void nalAnimClass<nalAnyPose>::nalInstanceClass::VirtualGetPose(Float a1, Float a2, nalBasePose &a3,
                                                                const nalBasePose &a4)
{
    void(__fastcall * func)(void *, void *edx, Float, Float, nalBasePose *, const nalBasePose *) =
...
template <>
void nalAnimClass<nalAnyPose>::nalInstanceClass::GetPose(Float a2, Float a3, nalAnyPose &pose,
                                                         const nalAnyPose &defaultPose)
{
    ...
    this->VirtualGetPose(a2, a3, *v7, *v9);
}
...
{
    if (skeleton != nullptr) {
        assert((skeleton == nullptr || Compatible(GetSkeleton(), skeleton)) &&
