...
nalMatrix4x4 *nalGenericSkeleton::GetBoneMatrices(const nalGeneric::nalGenericPose *a2, nalMatrix4x4 *a3) const
{
    if constexpr (0) {
    } else {
...
void nalGenericSkeleton::_Process()
{
    ...
    if constexpr (1) {
        ...
        for (int i = 0; i < this->field_88; ++i) {
            ...
            this->field_8C[i].field_20 = static_cast<decltype(this->field_8C[i].field_20)>(inst->field_20);
        }
...
void nalGenericSkeleton::GetComponentHandle<nalPositionOrientation>(
    nalGenericConstComponentHandle<nalPositionOrientation> &a2, tlFixedString &a3, tlFixedString &a4) const
{
    THISCALL(0x004AE7B0, this, &a2, &a3, &a4);
}

template <>
void nalGenericSkeleton::GetComponentHandle<float>(nalGenericComponentHandle<float> &a2, tlFixedString &a3,
                                                   tlFixedString &a4)
{
...
template <>
void nalGenericSkeleton::GetComponentHandle<float>(nalGenericConstComponentHandle<float> &a2, tlFixedString &a3,
...
template <>
void nalGenericSkeleton::GetComponentHandle<nalPositionOrientation>(
    nalGenericComponentHandle<nalPositionOrientation> &a2, tlFixedString &a3, tlFixedString &a4)
{
    THISCALL(0x004AE660, this, &a2, &a3, &a4);
}

template <>
void nalGenericSkeleton::GetComponentHandle<unsigned char>(nalGenericComponentHandle<unsigned char> &a2,
                                                           tlFixedString &a3, tlFixedString &a4)
{
    THISCALL(0x004AEB40, this, &a2, &a3, &a4);
}

template <>
void nalGenericSkeleton::GetComponentHandle<nalVector3>(nalGenericConstComponentHandle<nalVector3> &a2, uint32_t a3,
                                                        tlFixedString &a4) const
{
...
nalGeneric::nalGenericPose::nalGenericPose(const nalGeneric::nalGenericSkeleton *a3)
{
    ...
    for (int v4 = 0; v4 < v9->field_88; ++v4) {
        ...
        vtbl->Construct(v10->field_20, nullptr, v10, v3);
        ++v10;
    }
}

nalGeneric::nalGenericPose::nalGenericPose(const nalGeneric::nalGenericPose &a3, bool a4)
{
    auto v4 = a3.field_0;
