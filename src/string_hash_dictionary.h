...
//0x0053DD00
extern bool register_in_tree(mAvlTree<string_hash_entry> *a1, const char *str, const string_hash &a3);
...
//0x0050DC80
extern mString figure_out_filename(const char *a2, const char *dict_filename, const char *dict_ext);
