...
void physics_inode::cleanup_from_swing()
{
    if constexpr (1) {
        ...
        auto v17 = pb.get_optional_pb_float(physics_normal_drag_min_speed_id, g_normal_air_res_min_speed, nullptr);

        auto v18 = pb.get_optional_pb_float(physics_normal_drag_horz_scale_id, g_normal_air_res_horz_scale, nullptr);

        auto v19 = pb.get_optional_pb_float(physics_normal_drag_up_scale_id, g_normal_air_res_up_scale, nullptr);

        auto v20 = pb.get_optional_pb_float(physics_normal_drag_down_scale_id, g_normal_air_res_down_scale, nullptr);
        ...
        this->field_1C->m_gravity_multiplier =
            pb.get_optional_pb_float(physics_gravity_normal_id, g_normal_gravity, nullptr);
...
void physics_inode::apply_force_increment(const vector3d &a2, physical_interface::force_type a3, const vector3d &a4,
                                          int a5)
{
