...
void interactable_interface::add_interface_to_list(interactable_interface *who_to_add)
{
    ...
    if constexpr (0) {
        ...
        void(__fastcall * sub_5E4BD0)(void *, void *, void *, int, interactable_interface **) =
            CAST(sub_5E4BD0, 0x005E4BD0);
        sub_5E4BD0(&all_ifcs(), nullptr, all_ifcs().m_last, 1, &who_to_add);
    }
}
