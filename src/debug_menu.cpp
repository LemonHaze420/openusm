    ...
    if (active_menu == nullptr || has_focus) {
        if (virtual_input_state[8]) {
            if (active_menu != nullptr) {
                hide();
            } else if (spider_monkey::is_running() || !os_developer_options::instance->get_flag("ENABLE_ZOOM_MAP") ||
...
debug_menu_entry::debug_menu_entry(debug_menu *submenu) : field_20{0.0f, 1.0f, 0.1f, 10.0f}
{
...
void _populate_missions()
{
    ...
    std::for_each(
        &v2->m_district_table_containers[0], &v2->m_district_table_containers[0] + count, [&handle_table](auto *table) {
            auto *reg = table->get_region();
...
void debug_menu_entry::on_change(float a3, bool a4)
{
    ...
    case ValueType::FLOAT:
    case ValueType::POINTER_FLOAT: {
        float v6 = (a4 ? (this->field_20.m_step_size * this->field_20.m_step_scale) : this->field_20.m_step_size);
...
void debug_menu::add_entry(debug_menu_entry *e)
{
    ...
    if (this->first != nullptr) {
        ...
        for (; v12 != nullptr && v12->value_type == ValueType::POINTER_MENU; v11 = v12, v12 = v12->next) {
        ...
        if (e->value_type != ValueType::POINTER_MENU) {
            for (; v12 != nullptr; v11 = v12, v12 = v12->next) {
                if (this->m_sort_mode != sort_mode_t::undefined) {
                    mString v9;
                    mString v4;

                    if (this->m_sort_mode != sort_mode_t::ascending ||
                        (v9 = e->get_name(), v4 = v12->get_name(), !(v4 > v9))) {
