...
void spawnable::do_spawn(vector3d a4, vector3d a2, traffic_path_lane *lane, bool a10, bool a11)
{
    void(__fastcall * func)(void *, void *edx, vector3d, vector3d, traffic_path_lane *, bool, bool) =
