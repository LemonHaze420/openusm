...
struct scripted_trans_group : transition_group_base {
    ...
    bool check_transition(request_data &a2, scripted_trans_group::transition_type a3, als_data a4,
                          string_hash a5) const;
};

extern bool test_all_trans_groups(request_data &a1, const mVectorBasic<int> &a2,
                                  scripted_trans_group::transition_type a3, als_data a4, string_hash a5);
