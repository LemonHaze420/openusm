...
TEST(Matrix4x4, sub_771190)
{
    math::MatClass<4, 3> bones[2] = {
        matrix4x4{1.00, 0.09, 0.02, 0.00, -0.02, 0.01, 1.00, 0.00, 0.09, -1.00, 0.01, 0.00, 0.70, 0.02, -0.37, 0.00},
    ...
    matrix4x4 matrixFromMeshNode{
        1.00, 0.00, 0.00, 0.00, 0.00, 1.00, 0.00, 0.00, 0.00, 0.00, 1.00, 0.00, 1280.00, -16.54, 786.72, 0.00};
    ...
    const matrix4x4 expectedMat{
        -0.12, 0.05, -0.99, -0.00, -0.53, 0.84, 0.11, -0.00, 0.84, 0.54, -0.07, 0.00, -0.19, -0.04, -0.39, -0.00};
